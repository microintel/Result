...
window.alert("INVALID REGNO")
        ...
        document.getElementById('d15').innerHTML = data[h][14]+"/340";
        document.getElementById('d16').innerHTML = data[h][15]+"/550";
...
window.alert("INVALID REGNO")
        ...
        document.getElementById('d14').innerHTML = data[h][13]+"/450";
